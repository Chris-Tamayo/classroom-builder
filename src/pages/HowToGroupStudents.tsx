      ...
      <main className="container mx-auto px-4 py-10 max-w-3xl">
        ...
        <article className="space-y-10 text-base leading-relaxed text-foreground/90">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">Why Random Grouping Matters</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">Common Grouping Strategies (and Their Downsides)</h2>
          ...
          <section className="space-y-6">
            <h2 className="text-2xl font-semibold text-foreground">Best Practices for Random Grouping</h2>

            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-foreground">1. Rotate Groups Frequently</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-foreground">2. Use Pair Avoidance</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-foreground">3. Allow Post-Generation Adjustments</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-foreground">4. Be Transparent with Students</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="text-lg font-semibold text-foreground">5. Match Group Size to the Activity</h3>
              <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">When to Use Random Groups vs. Intentional Groups</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">How ClassroomBuilder Makes It Easy</h2>
            <p>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-semibold text-foreground">Try It Now</h2>
            <p>
